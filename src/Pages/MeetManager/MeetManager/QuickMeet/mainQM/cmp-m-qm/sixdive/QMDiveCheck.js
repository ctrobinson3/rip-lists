...
const QMDiveCheck = ({ entry, verify, setVerified, diver }) => {
	...
	var dd = (d) => {
		...
		if (total > 0) {
			return (
				<div className='dive-display'>Optional DD: {total.toFixed(1)}</div>
			);
		}
	};
